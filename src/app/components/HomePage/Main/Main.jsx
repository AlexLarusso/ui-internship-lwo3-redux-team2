...
const Main = () => (
  <div>
    ...
    <section className="content__container content__wrapper">
      ...
      <Button buttonText="All collection" classes="defaultButton" />
      <div className="product__wrapper">
        <div className="col-3 product__item">
          <img
    ...
    <section className="content__container content__wrapper">
      <form className="col-10 subscribe__form">
        ...
        <Button buttonText="Subscribe" classes="defaultButton accentButton" />
      </form>
    </section>
    ...
    <section className="content__container content__wrapper">
      ...
      <Button buttonText="Show me more" classes="defaultButton" />
    </section>
